...
#ifndef MANTISMODULE_H
#define MANTISMODULE_H
...
extern "C" {
	...
	/**
	\brief Mantis module implementation.
	*/
    class  MantisModule : public BugtrackerModule
    {
    public:
				/**
    ...
    {
        return MantisModule::getModuleInstance();
    }

    CLIENT_MODULE_EXPORT void destroy_module_instance(ClientModule *in_module_instance)
    {
        MantisModule::destroyModuleInstance(in_module_instance);
    }
